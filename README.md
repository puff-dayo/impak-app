...
This is a multi-platform desktop GUI application to browse, view and export from impak files, written with PySide and built using Nuitka.
...
Build and install with `/impak-decoder/build.bat` (read before running).
